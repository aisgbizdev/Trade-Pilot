...
**How to apply:** Keep account tier, free trading funds, and risk style as separate inputs. Do not reject free margin solely because it is below an account-opening minimum; only display opening minimums that are supported by an official source.
