    ...
    articles: [
      {
        ...
        keywords: ["instrument", "instrumen", "timeframe", "mode", "context", "konteks", "analyze", "analisis", "loading", "quota"],
        content_en: [
          ...
          { type: "p", val: "Choose the instrument, timeframe, and mode. Optional chart or news context adds your observation; it does not override market evidence. Trade Pilot checks the available categories of data, synthesizes agreements and conflicts, then returns a bias, confidence range, reasoning, risks, and a plan when the evidence supports one." },
          ...
          { type: "callout", val: "Trade Pilot supports your decision; it does not execute trades or guarantee profit." },
        ],
        content_id: [
          ...
          { type: "p", val: "Pilih instrumen, timeframe, dan mode. Konteks chart atau berita yang kamu tulis menjadi observasi tambahan, bukan pengganti bukti market. Trade Pilot memeriksa kategori data yang tersedia, menyatukan bagian yang searah maupun bertentangan, lalu menyajikan bias, rentang confidence, alasan, risiko, dan plan saat buktinya memadai." },
          ...
          { type: "callout", val: "Trade Pilot mendukung keputusanmu; bukan eksekutor trade dan bukan jaminan profit." },
        ],
      },
      {
        ...
        content_en: [
          ...
          { type: "p", val: "Trade Pilot synthesizes available technical and fundamental evidence for the selected timeframe. Confidence reflects the quality, consistency, and conflicts in that evidence—not a historical win probability." },
        ...
        content_id: [
          ...
          { type: "h", val: "Bagaimana hasil didapat" },
          { type: "p", val: "Trade Pilot menyintesis bukti teknikal dan fundamental yang tersedia untuk timeframe pilihan. Confidence mencerminkan kualitas, konsistensi, dan konflik bukti tersebut—bukan statistik peluang menang." },
      ...
      },
      {
        ...
        content_en: [
          ...
          { type: "p", val: "No single indicator or headline automatically decides the result. Trade Pilot looks for alignment and conflict across available categories, then explains which scenario is better supported. Citations connect narrative claims to the saved news and calendar snapshot." },
        ...
        content_id: [
          ...
          { type: "p", val: "Tidak ada satu indikator atau headline yang otomatis menentukan hasil. Trade Pilot mencari keselarasan dan konflik antar-kategori yang tersedia, lalu menjelaskan skenario mana yang lebih didukung. Sitasi menghubungkan narasi dengan snapshot berita dan kalender yang tersimpan." },
