  ...
  return (
    <Layout>
      <div className="px-4 py-6 space-y-6 md:px-6">
        ...
        {/* Weekly chart is the visual anchor of the page: it renders full-width,
            ahead of the supporting stat/detail cards below, with a touch more
            padding and heading weight than the surrounding cards. */}
        {analytics.weeklyData?.length > 0 && (
          <Card className="p-5">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
              <h3 className="text-base font-semibold text-foreground">{t.analytics.weekly_chart}</h3>
              <div
                role="tablist"
        ...
        {/* Supporting detail cards: subordinate to the chart above, so they
            stay at the compact p-4 / text-sm scale used elsewhere. */}
        <div className="space-y-6 md:space-y-0 md:columns-2 md:gap-x-6">
        {analytics.topInstruments?.length > 0 && (
          <Card className="p-4 md:mb-6 md:break-inside-avoid">
        ...
        <div className="grid grid-cols-2 gap-3 md:contents">
          ...
          <Card className="p-4 flex flex-col items-center md:mb-6 md:break-inside-avoid">
