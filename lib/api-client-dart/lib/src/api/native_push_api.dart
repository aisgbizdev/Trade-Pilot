...
class NativePushApi {
  ...
  Future<Response<MessageResponse>> registerNativePushDevice({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(nativePushRegisterBody, specifiedType: _type);
  ...
  Future<Response<MessageResponse>> unregisterNativePushDevice({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(nativePushUnregisterBody, specifiedType: _type);
