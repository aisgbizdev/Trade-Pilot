...
class ProgressionApi {
  ...
  Future<Response<ProgressionAward>> recordProgressionActivity({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(progressionActivityInput, specifiedType: _type);
  ...
  Future<Response<ProgressionEvidenceSession>> startProgressionEvidence({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(progressionEvidenceStartInput, specifiedType: _type);
