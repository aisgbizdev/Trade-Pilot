...
class AuthApi {
  ...
  Future<Response<MessageResponse>> deleteAccount({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(deleteAccountBody, specifiedType: _type);
  ...
  Future<Response<AuthResponse>> loginWithAppleNative({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(appleNativeLoginBody, specifiedType: _type);
  ...
  Future<Response<AuthResponse>> loginWithGoogleNative({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(googleNativeLoginBody, specifiedType: _type);
  ...
  Future<Response<GoogleReauthResponse>> reauthenticateWithGoogle({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(googleReauthBody, specifiedType: _type);
