...
class TopupsApi {
  ...
  Future<Response<DokuCheckoutSession>> createDokuCheckout({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createDokuCheckoutBody, specifiedType: _type);
  ...
  Future<Response<DokuTopupStatus>> getDokuTopupStatus({ 
    ...
    final _path = r'/topups/doku/{id}/status'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
