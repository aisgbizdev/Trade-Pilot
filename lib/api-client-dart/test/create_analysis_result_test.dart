...
// tests for CreateAnalysisResult
void main() {
  final instance = CreateAnalysisResultBuilder();
  // TODO add properties to the builder and call build()

  group(CreateAnalysisResult, () {
    // int id
    ...
    // bool creditConsumed
    test('to test the property `creditConsumed`', () async {
      // TODO
    });

    // int creditBalance
    test('to test the property `creditBalance`', () async {
      // TODO
    });
