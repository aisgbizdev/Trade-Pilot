...
// tests for AnalysisHistoryTimeframeStats
void main() {
  final instance = AnalysisHistoryTimeframeStatsBuilder();
  // TODO add properties to the builder and call build()

  group(AnalysisHistoryTimeframeStats, () {
    // int total
    ...
    // int activeValid
    test('to test the property `activeValid`', () async {
      // TODO
    });
