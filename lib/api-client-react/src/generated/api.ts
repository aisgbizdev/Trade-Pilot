...
export const getGetTopupConfigQueryKey = () => {
  return [`/api/topups/config`] as const;
};

export const getGetTopupConfigQueryOptions = <
  TData = Awaited<ReturnType<typeof getTopupConfig>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTopupConfig>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTopupConfig>>> = ({
    signal,
  }) => getTopupConfig({ signal, ...requestOptions });
...
export type GetTopupConfigQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTopupConfig>>
>;
...
export const getGetCreditBalanceQueryKey = () => {
  return [`/api/topups/balance`] as const;
};
...
export const getGetMyTopupRequestsUrl = (params?: GetMyTopupRequestsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/topups/mine?${stringifiedParams}`
    : `/api/topups/mine`;
};
 ...
 */
export const getMyTopupRequests = async (
  params?: GetMyTopupRequestsParams,
  options?: Parameters<typeof customFetch>[1],
): Promise<TopupRequestList> => {
...
export const getGetMyTopupRequestsQueryKey = (
  params?: GetMyTopupRequestsParams,
) => {
  return [`/api/topups/mine`, ...(params ? [params] : [])] as const;
};

export const getGetMyTopupRequestsQueryOptions = <
  TData = Awaited<ReturnType<typeof getMyTopupRequests>>,
  TError = ErrorType<void>,
>(
  params?: GetMyTopupRequestsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getMyTopupRequests>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetMyTopupRequestsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getMyTopupRequests>>
  > = ({ signal }) => getMyTopupRequests(params, { signal, ...requestOptions });
...
export type GetMyTopupRequestsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMyTopupRequests>>
>;
...
export const getGetPendingTopupRequestsUrl = (
  params?: GetPendingTopupRequestsParams,
) => {
  const normalizedParams = new URLSearchParams();
...
export const getPendingTopupRequests = async (
  params?: GetPendingTopupRequestsParams,
  options?: Parameters<typeof customFetch>[1],
): Promise<TopupRequestWithUserList> => {
  return customFetch<TopupRequestWithUserList>(
    getGetPendingTopupRequestsUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getGetPendingTopupRequestsQueryKey = (
  params?: GetPendingTopupRequestsParams,
) => {
  return [`/api/admin/topups`, ...(params ? [params] : [])] as const;
};

export const getGetPendingTopupRequestsQueryOptions = <
  TData = Awaited<ReturnType<typeof getPendingTopupRequests>>,
  TError = ErrorType<ErrorResponse>,
>(
  params?: GetPendingTopupRequestsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getPendingTopupRequests>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetPendingTopupRequestsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPendingTopupRequests>>
  > = ({ signal }) =>
    getPendingTopupRequests(params, { signal, ...requestOptions });
...
export type GetPendingTopupRequestsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPendingTopupRequests>>
>;
...
export function useGetPendingTopupRequests<
  TData = Awaited<ReturnType<typeof getPendingTopupRequests>>,
  TError = ErrorType<ErrorResponse>,
>(
  params?: GetPendingTopupRequestsParams,
 ...
 */
export const reviewCreditTopupRequest = async (
  id: number,
  reviewTopupRequestBody: ReviewTopupRequestBody,
  options?: Parameters<typeof customFetch>[1],
): Promise<TopupRequest> => {
  const getHeaders = (
    h?: NonNullable<RequestInit["headers"]>,
...
export const getReviewCreditTopupRequestMutationKey = () =>
  ["reviewCreditTopupRequest"] as const;

export const getReviewCreditTopupRequestMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ReviewCreditTopupRequestMutationResult = NonNullable<
  Awaited<ReturnType<typeof reviewCreditTopupRequest>>
>;
export type ReviewCreditTopupRequestMutationBody =
  BodyType<ReviewTopupRequestBody>;
export type ReviewCreditTopupRequestMutationError = ErrorType<ErrorResponse>;
export type ReviewCreditTopupRequestMutationVariables = {
  id: number;
  data: BodyType<ReviewTopupRequestBody>;
};

/**
 * @summary Approve or reject a top-up request, crediting the user's balance on approval
 */
export const useReviewCreditTopupRequest = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getGetTopupSummaryQueryKey = () => {
  return [`/api/admin/topups/summary`] as const;
};

export const getGetTopupSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getTopupSummary>>,
  TError = ErrorType<ErrorResponse>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTopupSummary>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTopupSummary>>> = ({
    signal,
  }) => getTopupSummary({ signal, ...requestOptions });
...
export type GetTopupSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTopupSummary>>
>;
...
export const getLoginWithGoogleNativeUrl = () => {
  return `/api/auth/google/native`;
};

/**
 * For mobile apps that obtain a Google **ID token** with the native
 * Google SDK. The server verifies the token (signature, issuer,
 * audience against the configured allowlist, expiry, verified email),
 * upserts the account (match google_id → link by verified email →
 * create), and returns a normal TradePilot Bearer session. No cookie
 * is set or required. The response never contains the Google token.
 * @summary Exchange a native-app Google ID token for a TradePilot session
 */
export const loginWithGoogleNative = async (
  ...
  return customFetch<AuthResponse>(getLoginWithGoogleNativeUrl(), {
    ...options,
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
export const getLoginWithGoogleNativeMutationKey = () =>
  ["loginWithGoogleNative"] as const;

export const getLoginWithGoogleNativeMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof loginWithGoogleNative>>,
    TError,
    LoginWithGoogleNativeMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getLoginWithGoogleNativeMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return loginWithGoogleNative(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type LoginWithGoogleNativeMutationResult = NonNullable<
  Awaited<ReturnType<typeof loginWithGoogleNative>>
>;
export type LoginWithGoogleNativeMutationBody = BodyType<GoogleNativeLoginBody>;
export type LoginWithGoogleNativeMutationError = ErrorType<ErrorResponse>;
export type LoginWithGoogleNativeMutationVariables = {
  data: BodyType<GoogleNativeLoginBody>;
};

/**
 * @summary Exchange a native-app Google ID token for a TradePilot session
 */
export const useLoginWithGoogleNative = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getLoginWithGoogleNativeMutationOptions(options));
};

export const getReauthenticateWithGoogleUrl = () => {
  return `/api/auth/reauth/google`;
};

/**
 * A live session alone is not sufficient for sensitive operations on
 * a Google-only account. The client obtains a **fresh** Google ID
 * token and posts it here; on success the server returns a short-lived
 * (≤5 min), single-use `reauthToken` bound to the user and to the
 * `delete_account` purpose. Currently consumed by DELETE /auth/account.
 * @summary Prove identity with a fresh Google ID token for a sensitive operation
 */
export const reauthenticateWithGoogle = async (
  googleReauthBody: GoogleReauthBody,
  options?: Parameters<typeof customFetch>[1],
): Promise<GoogleReauthResponse> => {
  const getHeaders = (
    h?: NonNullable<RequestInit["headers"]>,
  ): Record<string, string | readonly string[]> => {
    if (!h) return {};
  ...
  return customFetch<GoogleReauthResponse>(getReauthenticateWithGoogleUrl(), {
    ...options,
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    body: JSON.stringify(googleReauthBody),
  });
};

export const getReauthenticateWithGoogleMutationKey = () =>
  ["reauthenticateWithGoogle"] as const;

export const getReauthenticateWithGoogleMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof reauthenticateWithGoogle>>,
    TError,
    ReauthenticateWithGoogleMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getReauthenticateWithGoogleMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return reauthenticateWithGoogle(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ReauthenticateWithGoogleMutationResult = NonNullable<
  Awaited<ReturnType<typeof reauthenticateWithGoogle>>
>;
export type ReauthenticateWithGoogleMutationBody = BodyType<GoogleReauthBody>;
export type ReauthenticateWithGoogleMutationError = ErrorType<ErrorResponse>;
export type ReauthenticateWithGoogleMutationVariables = {
  data: BodyType<GoogleReauthBody>;
};

/**
 * @summary Prove identity with a fresh Google ID token for a sensitive operation
 */
export const useReauthenticateWithGoogle = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getReauthenticateWithGoogleMutationOptions(options));
};

export const getLoginWithAppleNativeUrl = () => {
  return `/api/auth/apple/native`;
};

/**
 * For mobile apps that obtain an **identity token** + **authorization
 * code** with Apple's native Sign in with Apple SDK. The client
 * generates a random raw nonce, sends its SHA-256 hash to Apple, and
 * posts the raw nonce here alongside the identity token.
 *
 * The server verifies the identity token's signature against Apple's
 * published JWKS (never a bare decode), its issuer, audience (against
 * `APPLE_ALLOWED_CLIENT_IDS`), expiry, and that the token's `nonce`
 * claim equals SHA-256(raw nonce) — then independently exchanges the
 * authorization code with Apple's own token endpoint as a second,
 * server-to-server proof that it is genuine, unexpired, and unused.
 * It then upserts the account (match apple_id → link by verified
 * email → create) and returns a normal TradePilot Bearer session. No
 * cookie is set or required. The response never contains the Apple
 * identity token, authorization code, or any Apple token-endpoint
 * credential.
 *
 * `givenName`/`familyName` are only ever used as a display-name
 * candidate when creating a brand-new account — Apple only sends them
 * on the very first authorization for this app, and a later login
 * succeeds on `sub` alone even with no name or email in the token.
 * @summary Exchange a native Sign in with Apple identity token for a TradePilot session
 */
export const loginWithAppleNative = async (
  appleNativeLoginBody: AppleNativeLoginBody,
  options?: Parameters<typeof customFetch>[1],
): Promise<AuthResponse> => {
  const getHeaders = (
    h?: NonNullable<RequestInit["headers"]>,
  ...
  return customFetch<AuthResponse>(getLoginWithAppleNativeUrl(), {
    ...options,
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    body: JSON.stringify(appleNativeLoginBody),
  });
};

export const getLoginWithAppleNativeMutationKey = () =>
  ["loginWithAppleNative"] as const;

export const getLoginWithAppleNativeMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof loginWithAppleNative>>,
    TError,
    LoginWithAppleNativeMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getLoginWithAppleNativeMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return loginWithAppleNative(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type LoginWithAppleNativeMutationResult = NonNullable<
  Awaited<ReturnType<typeof loginWithAppleNative>>
>;
export type LoginWithAppleNativeMutationBody = BodyType<AppleNativeLoginBody>;
export type LoginWithAppleNativeMutationError = ErrorType<ErrorResponse>;
export type LoginWithAppleNativeMutationVariables = {
  data: BodyType<AppleNativeLoginBody>;
};

/**
 * @summary Exchange a native Sign in with Apple identity token for a TradePilot session
 */
export const useLoginWithAppleNative = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getLoginWithAppleNativeMutationOptions(options));
};

export const getReauthenticateWithAppleUrl = () => {
  return `/api/auth/reauth/apple`;
};

/**
 * A live session alone is not sufficient for sensitive operations on
 * an Apple-only account. The client repeats the native Sign in with
 * Apple flow to obtain a **fresh** identity token + authorization
 * code + raw nonce and posts them here; on success the server returns
 * a short-lived (≤5 min), single-use `reauthToken` bound to the user
 * and to the `delete_account` purpose — the same token shape and the
 * same consumer (DELETE /auth/account) as POST /auth/reauth/google.
 * The Apple `sub` in the fresh token must match the signed-in
 * account's stored `apple_id`.
 * @summary Prove identity with a fresh Apple identity token for a sensitive operation
 */
export const reauthenticateWithApple = async (
  appleReauthBody: AppleReauthBody,
  options?: Parameters<typeof customFetch>[1],
): Promise<AppleReauthResponse> => {
  const getHeaders = (
    h?: NonNullable<RequestInit["headers"]>,
  ): Record<string, string | readonly string[]> => {
    if (!h) return {};
  ...
  return customFetch<AppleReauthResponse>(getReauthenticateWithAppleUrl(), {
    ...options,
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    ...
    body: JSON.stringify(appleReauthBody),
  });
};

export const getReauthenticateWithAppleMutationKey = () =>
  ["reauthenticateWithApple"] as const;

export const getReauthenticateWithAppleMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof reauthenticateWithApple>>,
    TError,
    ReauthenticateWithAppleMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getReauthenticateWithAppleMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return reauthenticateWithApple(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ReauthenticateWithAppleMutationResult = NonNullable<
  Awaited<ReturnType<typeof reauthenticateWithApple>>
>;
export type ReauthenticateWithAppleMutationBody = BodyType<AppleReauthBody>;
export type ReauthenticateWithAppleMutationError = ErrorType<ErrorResponse>;
export type ReauthenticateWithAppleMutationVariables = {
  data: BodyType<AppleReauthBody>;
};

/**
 * @summary Prove identity with a fresh Apple identity token for a sensitive operation
 */
export const useReauthenticateWithApple = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getSendNativePushTestUrl = () => {
  return `/api/native-push/test`;
};

/**
 * Native-channel equivalent of POST /push/test. Sends one sample
 * notification through the exact `sendNativePushToUser` code path
 * production uses, so a passing result is real proof the FCM HTTP v1
 * wiring works. Authenticated + per-user rate limited. Does not accept
 * a device token or a URL from the request body. Unlike /push/test,
 * the outcome reflects FCM's per-message acceptance — see
 * NativePushTestResult.
 * @summary Send a sample FCM push to the caller's own registered mobile devices
 */
export const sendNativePushTest = async (
  options?: Parameters<typeof customFetch>[1],
): Promise<NativePushTestResult> => {
  return customFetch<NativePushTestResult>(getSendNativePushTestUrl(), {
    ...options,
    method: "POST",
  });
};

export const getSendNativePushTestMutationKey = () =>
  ["sendNativePushTest"] as const;

export const getSendNativePushTestMutationOptions = <
  TError = ErrorType<ErrorResponse | NativePushTestResult>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof sendNativePushTest>>,
    TError,
    void,
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = getSendNativePushTestMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return sendNativePushTest(requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SendNativePushTestMutationResult = NonNullable<
  Awaited<ReturnType<typeof sendNativePushTest>>
>;

export type SendNativePushTestMutationError = ErrorType<
  ErrorResponse | NativePushTestResult
>;

/**
 * @summary Send a sample FCM push to the caller's own registered mobile devices
 */
export const useSendNativePushTest = <
  TError = ErrorType<ErrorResponse | NativePushTestResult>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSendNativePushTestMutationOptions(options));
};
